...
void print(Funcionario* funcionario)
{
	...
	while(aux != NULL)
	{
		...
		cout << "Salário: " << fixed << setprecision(2) << aux->salario << endl;
		cout << "-----------" << endl;
		aux = aux->prox;
	}
	...
	while(true)
	{
		...
		else if(escolha == 1)
		{
			...
			while(true)
			{
				...
				if(!valido)
				{
					cout << "Nome não pode conter números!" << endl;
					cout << endl;
					continue;
				}
			...
			while(true)
			{
				...
				if(entrada.empty())
				{
					cout << "Salário não pode ser vazio!" << endl << endl;
					continue;
				}
			...
			while(true)
			{
				...
				else
				{
					cout << "Prontuário pesquisado: "
						 ...
						 << "Salário: R$ " << fixed << setprecision(2) << procurado->salario << endl;
					cout << endl;
					break;
				}
			}
